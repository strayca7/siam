// Package serrors provides simple error handling primitives based on https://pkg.go.dev/github.com/pkg/errors.
//
...
func WithCode(code int, format string) error {
	return &withCode{
		err:   fmt.Errorf("%v", format),
		code:  code,
		stack: callers(),
	}
}
